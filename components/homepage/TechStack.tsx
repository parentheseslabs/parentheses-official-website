    ...
    return (
        <section className='min-h-svh px-[7%] flex justify-center items-center'>
            <div className='flex h-[70vh]'>
                <div className='bg-primary_blue rounded-l-3xl flex flex-col justify-center px-20 gap-8 text-white w-1/2'>
                    <div className='flex gap-8  items-center justify-center'>
                        <DarkLogo />
                        <div className='h-10 border-l-4 border-l-white'></div>
                        <h1 className='text-4xl font-sfpd-bold'>TECHSTACK</h1>
                    </div>
                    <h1 className='text-lg md:text-xl'>450+ pre-built integrations that you can enable with the flip of a switch.</h1>
                </div>
                <div className='border border-primary_blue  grid grid-cols-3 px-20 rounded-r-3xl justify-center items-center gap-12 w-1/2'>
                    {
                        data.map((item,idx)=>(
