    ...
    return (
        <div className='flex justify-center items-center py-28 min-h-screen'>
            <div className='bg-primary_blue w-[93%]  rounded-2xl lg:rounded-[2rem] flex justify-center items-center relative text-white flex-col gap-14 lg:gap-20 py-28 px-20 text-center'>
                <Image src={'/background/cardGrid.svg'} width={200} height={200} alt='grid' className='w-[60%] absolute -z-0 top-[50%] -translate-y-[50%] hidden md:flex opacity-50'></Image>
                <h1 className='font-sfpd-bold text-3xl sm:text-4xl lg:text-5xl translate-y-4'>Our Values</h1>
                <h2 className=' text-base sm:text-lg lg:text-2xl'>Our Core “Feed On” Prinicples</h2>
