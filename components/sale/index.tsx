...
const Sale = ({ ...props }: props) => {
    return (
        <div className={`${" "+props.className+" "} ${props.bg === 'white' ? " bg-white" : " bg-primary_blue text-white"} w-full  text-sm font-sfpd-regular flex gap-4 items-center justify-center py-2 absolute z-[100] text-black top-0`}>
            <h1>
