...
const Drawer = () => {
    ...
    return (
        <motion.div
            ...
            animate="visible"
            exit="exit"
            className='absolute z-[999999] top-0 right-0 lg:w-[40%] min-h-svh bg-white/60 border-l border-l-primary_blue backdrop-blur-xl flex items-center px-8 md:px-10 text-neutral-700'>
            ...
            <div className='w-full space-y-4'>
                ...
                <form action="" className='space-y-10 '>
                    ...
                    <div className='flex gap-4'>
                        <select name="countryCode" id="" className='bg-transparent w-[40%] outline-none border-b border-b-gray-500 focus:border-b-primary_blue'>
            ...
            <div
                ...
                className='size-9 md:size-14 bg-white drop-shadow-sm rounded-full absolute left-4 top-4 flex justify-center items-center'>
                <div className='absolute w-6 md:w-8 py-[0.1rem] md:py-[0.14rem] bg-primary_blue rounded-full rotate-45'></div>
                <div className='absolute w-6 md:w-8 py-[0.1rem] md:py-[0.14rem] bg-primary_blue rounded-full -rotate-45'></div>
            </div>
        </motion.div>
    )
