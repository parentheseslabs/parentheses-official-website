            ...
            <div className='w-full space-y-4'>
                ...
                <form action="" className='space-y-10'>
                    ...
                    <div>
                        ...
                        <textarea name="" id="" rows={2} className='w-full bg-transparent outline-none focus:border-b-primary_blue border-b border-b-gray-500 py-3 px-4 italic flex items-end' placeholder='Your message'></textarea>
                    </div>
