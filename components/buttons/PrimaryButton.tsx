...
{
  return (
    <button className='pl-8 pr-12 h-fit py-3 rounded-full border border-primary_blue  text-white hover relative group overflow-hidden flex items-center gap-2 hover:text-primary_blue duration-500 text-xs md:text-sm xl:text-[16px] z-50 bg-primary_blue active:scale-[.8]'>
        {props.title}
