...
{
  return (
    <button className='pl-7 pr-9 h-fit py-2 rounded-full border border-primary_blue text-primary_blue hover relative group overflow-hidden flex items-center gap-2 hover:text-white duration-500 text-xs md:text-sm xl:text-[16px] z-50 bg-white'>
        {props.title}
