...
const Footer: React.FC = () => {
  ...
  return (
    <div className='min-w-full min-h-[80svh] bg-primary_blue relative overflow-hidden py-36 md:py-56 px-[4%] text-white flex flex-col items-center'>
      ...
      <a href='#hero' className=' absolute right-[5vmax] top-[5vmax] bg-white rounded-full p-3 sm:p-4 md:p-5 lg:p-6'>
        <div className='size-[2.2vmax] border-l-4 border-b-4 border-primary_blue rotate-[135deg] translate-y-[0.7vmax]'></div>
      </a>
